 ...
 * the specified port yet exists, and openNew is true, the function establishes
 * a new connection and returns that.
 *
 ...
 */
PGconn *
GetConnection(char *nodeName, int32 nodePort, bool openNew)
{
