...
CREATE FUNCTION alter_server_host_and_port_command(server_name cstring,
												   host cstring,
												   port cstring)
	RETURNS text
	AS 'pg_shard'
...
-- independently test option-generation code
SELECT alter_server_host_and_port_command('fake_fdw_server', 'localhost', '5432');
