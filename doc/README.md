...
We have migration steps to help existing customers perform a drop-in replacement. [Contact us](mailto:engage@citusdata.com?subject=pg_shard%20Migration) for more information, or feel free to stop by our [Slack room](https://slack.citusdata.com/) to have questions answered in real-time.
